#!/usr/bin/env python3
# =============================================================================
# Launch file: Gazebo Harmonic (headless) + simple diff-drive robot + rviz2
# =============================================================================
...
def generate_launch_description():
    ...
    # ----- Gazebo Sim (SERVER ONLY + headless rendering for sensors) -----
    ...
    gazebo_server = IncludeLaunchDescription(
        ...
        launch_arguments=[
            ('gz_args', [
                ...
                ' --headless-rendering',  # EGL rendering for sensors without X
                ' -v 4',
            ])
        ]
    )
    ...
    # ----- Fix lidar frame_id -----
    # Gazebo publishes frame as "simple_robot/base_footprint/lidar"
    # but URDF defines it as "lidar_link". This node remaps it.
    ...
    # ----- Cylinder markers for rviz -----
    cylinder_markers = Node(
        package='course_project',
        executable='publish_markers.py',
        name='cylinder_marker_publisher',
        parameters=[{
    ...
    ld.add_action(cylinder_markers)
    ld.add_action(rviz)
