#!/usr/bin/env python3
# =============================================================================
# Launch file: Gazebo Harmonic (headless) + simple diff-drive robot + labyrinth
# Usage:
#   ros2 launch course_project sim_labyrinth.launch.py
#   ros2 launch course_project sim_labyrinth.launch.py world:=labyrinth_2
# =============================================================================
...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='labyrinth_1',
        description='Name of the labyrinth world file (without .sdf extension)')
